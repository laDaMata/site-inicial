...
// Edição de comandos
jQuery("#container1").wowSlider({effect:"parallax",prev:"",next:"",duration:10*100,delay:20*100,width:1100,height:768,autoPlay:false,autoPlayVideo:false,playPause:false,stopOnHover:false,loop:false,bullets:true,caption:true,captionEffect:"fade",controls:true,responsive:1,fullScreen:false,onBeforeStep:0,images:0});